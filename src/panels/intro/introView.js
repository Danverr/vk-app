    ...
    const slidesData = [
        {
            ...
            text: "Это трекер настроения, тревожности и стресса для тебя и твоих близких. Личный дневник и статистика настроения друзей теперь в одном приложении ВК.",
            img: intro0,
        },
        {
            title: "Наша цель",
            text: "У всех бывают трудные дни, но не всегда с ними легко справится в одиночку. mood без лишних слов даст вам знать, когда близкому человеку потребуется ваша поддержка.",
            img: intro1,
        },
        {
        ...
        },
        {
            ...
            text: "Для того, чтобы вы могли поделится своим настроением, нам нужно знать, с кем вы дружите. Без доступа нельзя продолжить.",
            img: intro3,
